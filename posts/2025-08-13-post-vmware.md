...
前一段时间，UTM SE在苹果商店上架了，但使用它依旧是一件难事，今天我就教大家如何创立虚拟机并且怎样编辑让它的速度翻倍，助你以后虚拟机不求人。在 iOS 上玩出新花样。
...
这就是全部的教程了，按理说这样的虚拟机可以直接打开。但是给大家一句忠告，不要尝试在上面跑Windows 10这类版本，试也不建议试，因为这是一个se版本，没有jit，运行速度会非常慢。唯一可以流畅跑的只有win2000或者xp。
