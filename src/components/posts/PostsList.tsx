...
export function PostsList({ posts }: PostsListProps) {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white px-4 pb-20 pt-48 text-black dark:bg-black dark:text-white sm:px-6 sm:pt-52">
      ...
      <motion.header
        ...
        className="fixed top-4 left-1/2 z-50 w-[calc(100%-2rem)] max-w-5xl -translate-x-1/2 space-y-3 sm:space-y-4"
      >
        <NavBar />
